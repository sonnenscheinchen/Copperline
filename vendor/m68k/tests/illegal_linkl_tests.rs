...
#[test]
fn test_linkl_is_illegal_on_68000() {
    ...
    // LINK.L A0,#0 (0x4808) - 68020+ only
    bus.write_word_at(0x0200, 0x4808);
    bus.write_long_at(0x0202, 0x0000);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "LINK.L on 68000 should trap to illegal instruction vector"
    );
}
