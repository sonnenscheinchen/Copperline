...
#[test]
fn test_movec_tc_is_illegal_on_68020() {
    ...
    // MOVEC TC, D0 (control reg 0x003) should be illegal on 68020
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "MOVEC TC on 68020 should trap to illegal instruction vector"
    );
}
