...
#[test]
fn test_move_from_ccr_is_illegal_on_68000() {
    ...
    // MOVE CCR, D0 (0x42C0) - illegal on 68000 (68010+ only)
    bus.write_word_at(0x0200, 0x42C0);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "MOVE CCR,<ea> on 68000 should trap to illegal instruction vector"
    );
}
