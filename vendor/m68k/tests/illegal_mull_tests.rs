...
#[test]
fn test_mull_is_illegal_on_68000() {
    ...
    // MULL (0x4C00) is 68020+ only. Extension word is ignored for illegal trap.
    bus.write_word_at(0x0200, 0x4C00);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "MULL on 68000 should trap to illegal instruction vector"
    );
}
