...
#[test]
fn test_moves_is_illegal_on_68000() {
    ...
    // MOVES.W (opcode 0x0E00) with dummy extension word
    bus.write_word_at(0x0200, 0x0E00);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "MOVES on 68000 should trap to illegal instruction vector"
    );
}
