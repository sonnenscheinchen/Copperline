...
#[test]
fn test_cas_is_illegal_on_68000() {
    ...
    // CAS.L Dc,Du,(A0): opcode 0x0ED0 (size=long, mode=010 reg=000), extension word 0x0000
    bus.write_word_at(0x0200, 0x0ED0);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "CAS on 68000 should trap to illegal instruction vector"
    );
}
