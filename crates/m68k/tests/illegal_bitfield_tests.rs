...
#[test]
fn test_bitfield_is_illegal_on_68000() {
    ...
    // Bitfield opcode pattern (e.g., BFTST) with extension word
    bus.write_word_at(0x0200, 0xE8C0);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "Bitfield opcodes on 68000 should trap to illegal instruction vector"
    );
}
