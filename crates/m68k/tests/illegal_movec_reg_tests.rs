...
#[test]
fn test_movec_invalid_control_reg_is_illegal_on_68010() {
    ...
    // MOVEC CACR, D0 (control reg 0x002) should be illegal on 68010
    bus.write_word_at(0x0200, 0x4E7A);
    bus.write_word_at(0x0202, 0x0002);
    ...
    assert_eq!(
        cpu.pc, 0x0300,
        "MOVEC CACR on 68010 should trap to illegal instruction vector"
    );
}
